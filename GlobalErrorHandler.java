package songs.catalog.controller.error;
...
public class GlobalErrorHandler {
	...
	public ExceptionMessage handleNoSuchElementException (NoSuchElementException ex, WebRequest webRequest) {
		...
		return builExceptionMessage (ex, HttpStatus.NOT_FOUND, webRequest, LogStatus.MESSAGE_ONLY);
	}

	
	
	private ExceptionMessage builExceptionMessage(NoSuchElementException ex, HttpStatus status,
